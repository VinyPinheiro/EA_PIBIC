#ifndef AGLUTINAGEMANIMATION_H
#define AGLUTINAGEMANIMATION_H
...
class AglutinagemAnimation : public Level
{
public:
    AglutinagemAnimation(const string& next = "");
    ~AglutinagemAnimation() {}
