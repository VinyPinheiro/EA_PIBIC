#ifndef BIOOLEO_ISOMEROSANIMATION_H
#define BIOOLEO_ISOMEROSANIMATION_H
...
class Biooleo_isomerosAnimation : public Level
{
public:
    Biooleo_isomerosAnimation(const string& next = "");
    ~Biooleo_isomerosAnimation() {}
