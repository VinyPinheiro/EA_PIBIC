#ifndef BIOQUEROSENEANIMATION_H
#define BIOQUEROSENEANIMATION_H
...
class BioqueroseneAnimation : public Level
{
public:
    BioqueroseneAnimation(const string& next = "");
    ~BioqueroseneAnimation() {}
