    ...
    : Level("trituracaoAnimation", next)
{
    ...
    Text *question = new Text(this, "Realizar a aglutinagem?", Color::BLACK);
    ...
    Button *yes = new Button(this, "aglutinagemAnimation", 200, 100);
...
bool
Aglutinagem::on_message(Object *object, MessageID id, Parameters)
{
