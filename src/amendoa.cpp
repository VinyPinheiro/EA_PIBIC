    ...
    : Level("separacaoAnimation", next)
{
    ...
    Text *question = new Text(this, "Prensar a Amêndoa?", Color::BLACK);
    ...
    Button *yes = new Button(this, "amendoaAnimation", 200, 100);
...
bool
Amendoa::on_message(Object *object, MessageID id, Parameters)
{
