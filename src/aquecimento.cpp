    ...
    : Level("compactacaoAnimation", next)
{
    ...
    Text *question = new Text(this, "Aquecer briquete moldado", Color::BLACK);
    ...
    Text *question1 = new Text(this, "para diminuir a umidade?", Color::BLACK);
    ...
    Button *yes = new Button(this, "aquecimentoAnimation", 200, 100);
...
bool
Aquecimento::on_message(Object *object, MessageID id, Parameters)
{
