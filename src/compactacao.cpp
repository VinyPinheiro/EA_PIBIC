...
Compactacao::Compactacao(const string& next)
    : Level("lavagemAnimation", next)
{
    ...
    Text *question = new Text(this, "Compactar a mistura aglutinada?", Color::BLACK);
    ...
    Button *yes = new Button(this, "compactacaoAnimation", 200, 100);
...
bool
Compactacao::on_message(Object *object, MessageID id, Parameters)
{
