...
Fragmentacao::Fragmentacao(const string& next)
    : Level("prensagem_polpaAnimation", next)
{
    ...
    Text *question1 = new Text(this, "Fragmentar o endocarpo", Color::BLACK);
    Text *question2 = new Text(this, "e a Amêndoa?", Color::BLACK);
    ...
    Button *yes = new Button(this, "fragmentacaoAnimation", 200, 100);
...
bool
Fragmentacao::on_message(Object *object, MessageID id, Parameters)
{
