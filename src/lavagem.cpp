...
Lavagem::Lavagem(const string& next)
    : Level("aglutinagemAnimation", next)
{
    ...
    Text *question = new Text(this, "Lavar a mistura aglutinada?", Color::BLACK);
    ...
    Button *yes = new Button(this, "lavagemAnimation", 200, 100);
...
bool
Lavagem::on_message(Object *object, MessageID id, Parameters)
{
