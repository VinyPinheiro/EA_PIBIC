...
Separacao::Separacao(const string& next)
    : Level("fragmentacaoAnimation", next)
{
    ...
    Text *question1 = new Text(this, "Separar o endocarpo", Color::BLACK);
    Text *question2 = new Text(this, "da Amêndoa?", Color::BLACK);
    ...
    Button *yes = new Button(this, "separacaoAnimation", 200, 100);
...
bool
Separacao::on_message(Object *object, MessageID id, Parameters)
{
