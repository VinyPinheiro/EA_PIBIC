...
TrituracaoAnimation::TrituracaoAnimation(const string& next)
    : Level("trituracao", next)
{
...
void
TrituracaoAnimation::add_component(Type type, double x, double y, Cano::Tipo p)
{
    switch (type) {
    case CANO:
        {
...
void
TrituracaoAnimation::update_self(unsigned long elapsed)
{
